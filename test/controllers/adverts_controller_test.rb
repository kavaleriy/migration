...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { email: @advert.email, fio: @advert.fio, housing_id: @advert.housing_id, phone: @advert.phone }
    end
  ...
  test "should update advert" do
    patch :update, id: @advert, advert: { email: @advert.email, fio: @advert.fio, housing_id: @advert.housing_id, phone: @advert.phone }
    assert_redirected_to advert_path(assigns(:advert))
  end
